...
/// `bt_client`'s `BtLinkSession.hostId`). WiFi has nothing analogous — a
...
/// on first use, and reused for as long as `~/.config/BTLink/host_id`
/// exists.
abstract final class HostIdentity {
  ...
  static File? get _file {
    ...
    return File('$home/.config/BTLink/host_id');
  }
