...
plugins {
    ...
    // AGP 9's built-in Kotlin support replaces the separate kotlin-android
    // plugin — see the `kotlin { compilerOptions {} }` block below.
...
android {
    namespace = "com.chienhunglin.hotkeypad"
    ...
    defaultConfig {
        ...
        applicationId = "com.chienhunglin.hotkeypad"
    ...
    buildTypes {
        release {
            ...
            // `flutter build apk --release` still succeeds there.
